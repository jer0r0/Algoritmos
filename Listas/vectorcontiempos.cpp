...
public:
    ...
    int binary(int x){
        //Para encontrar el vector debe estar ordenado
        int ini = 0;
        int fin = size-1;
        int i= fin + ini /2;
        while(ini <= fin){
...
int main()
{
    ...
    cout<<v.binary(499999)<<endl;
    
    double finish= double(clock())/CLOCKS_PER_SEC;
    double elapsed = finish - start; 
    cout<< start<< " - "<< finish<< " = "<< elapsed<<endl; 
    //v.print();
    ...
    cout<<v.buscar(49999999)<<endl;
    
    double finish1= double(clock())/CLOCKS_PER_SEC;
    double elapsed1 = finish1 - start1; 
    cout<< start1<< " - "<< finish1<< " = "<< elapsed1<<endl; 
